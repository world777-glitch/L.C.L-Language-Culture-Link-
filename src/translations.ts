...
export const TRANSLATIONS: Record<LanguageCode, any> = {
  ko: {
    ...
    hero: {
      badge: '중국 응용언어학 박사가 제안하는 가장 정교한 중국어 솔루션',
      title: '언어는 학문이자 삶입니다',
      subtitle: '20년의 현지 유학 및 생활 경험과 응용언어학 박사의 전문 지식을 바탕으로, 단순 암기가 아닌 언어 습득의 원리를 깨우치는 압도적 강의를 경험해 보세요.',
      cta: '코스 탐색하기',
    },
    profile: {
      title: '📌 핵심 프로필',
      education: '학력: 중국 현지 응용언어학 박사 (우수졸업생)',
      experience: '경력: 한·중 현지 교학 경력 15년+',
      data: '데이터: 누적 수강생 700명+ 지도 및 다수의 합격자 배출',
      specialty: '전문 분야: HSK 전 등급 ; (1-6급)+ 7-9급(고등) , 국제학교(KISB, KIST 등) 내신 관리 전문',
    },
    programs: {
      title: '🎯 주요 수업 프로그램',
      items: [
        { title: '프리미엄 맞춤 회화', content: '응용언어학적 분석을 통한 정확한 성조와 원어민 어법 교정\n일상 생활에서 즉각적으로 활용 가능한 실전 회화 중심 과정' },
        { title: 'HSK 급수 보장 (1-6급)', content: '최신 출제 경향을 반영한 전략적 접근으로 최단기 합격 실현\n15년 이상의 풍부한 급수 강의 노하우로 HSK 4~6급 집중 공략' },
        { title: '[NEW] HSK 고등 마스터 (7-9급)', content: '박사 학위 과정에서 다룬 학술적 문헌 분석력을 바탕으로 고등 HSK 완벽 대비\n최상위 학습자를 위한 논리적 비판 및 전문 통번역 기술 전수' },
        { title: '중·고교 내신 및 제2외국어 완벽 대비', content: '국제학교(KISB, KIST 등) 및 일반 중·고교 내신 밀착 관리\n수강생 대다수 성적 80~100점대 유지 및 수행평가 완벽 대비' },
        { title: '고급 토론 및 비즈니스 중국어', content: '논리적 스피킹과 비판적 사고를 기르는 심화 토론 과정\n실무 회의, 계약, 프레젠테이션 중심의 전문 비즈니스 솔루션' }
      ]
    },
    differentiation: {
      title: '💎 이 쌤(Dr. Lee)만의 차별화 포인트',
      items: [
        { title: '검증된 학술 전문성', content: '박사 우수졸업생의 정교한 커리큘럼으로 학습의 질이 다릅니다.' },
        { title: '방대한 누적 데이터', content: '700여 명의 사례를 바탕으로 학생별 취약점을 즉각 진단하고 최적의 학습 경로를 제시합니다.' },
        { title: '결과로 증명하는 꼼꼼함', content: '강의로 끝내지 않습니다. 철저한 과제 체크와 맞춤 피드백으로 반드시 성적 향상을 이끌어냅니다.' },
        { title: '따뜻한 조력자', content: '학생의 잠재력을 믿고 끝까지 함께하는 러닝 메이트가 되어 드립니다.' }
      ]
    },
    consultation: {
      title: '📍 수업 및 상담 안내',
      items: [
        { label: '수업 형태', value: '100% 온라인 화상 수업 (시공간 제약 없는 효율적 학습)' },
        { label: '연락 가능 시간', value: '오전 10시 ~ 오후 8시 (상담 후 스케줄 조율)' },
        { label: '위치', value: '수원시 장안구 기반 (비대면 전문)' },
        { label: '비용', value: '학생의 수준과 수업 횟수에 따라 맞춤형 상담 진행' }
      ],
      footer: '"확실한 결과, 압도적인 전문성으로 중국어의 자신감을 찾아드립니다." 지금 바로 이 쌤만의 특화된 솔루션을 문의해 보세요.'
    },
    archive: {
      title: '지식 라이브러리',
