...
export const TRANSLATIONS: Record<LanguageCode, any> = {
  ko: {
    ...
    programs: {
      title: '🎯 주요 수업 프로그램',
      items: [
        { title: '[NEW] HSK 고등 마스터 (7-9급)', content: '박사 학위 과정에서 다룬 학술적 문헌 분석력을 바탕으로 고등 HSK의 독해/작문/번역 영역 완벽 대비\n최상위 학습자를 위한 논리적 비판 및 전문 통번역 기술 전수' },
        { title: 'HSK 급수 보장 (1-6급)', content: '최신 출제 경향을 반영한 전략적 접근으로 최단기 합격 실현\n특히 고득점이 관건인 HSK 4~6급 집중 공략 (15년 이상의 풍부한 급수 강의 노하우)' },
        { title: '국제학교 내신 밀착 관리', content: '대상: KISB, KIST 등 국내외 국제학교 재학생\n결과: 수강생 대다수 성적 80~100점대 유지 및 상향 평준화' },
        { title: '프리미엄 회화 & 비즈니스', content: '응용언어학적 분석을 통한 정확한 성조와 원어민 어법 교정\n중국 문화와 비즈니스 매너를 녹여낸 몰입형 수업으로 "말문이 트이는 중국어"' }
      ]
    },
    differentiation: {
